...
def main():
  ...
  print (" | '_ \ / _ \| '__| __| / __|/ __/ _` | '_ \| '_ \ / _ \ '__|   ")
  ...
  print (" Version : 1.0 ")
  print (" Usage Example = python open_port_scanner.py  -H 104.27.177.146 -p 80 -t 80 ")
  parser=argparse.ArgumentParser(description="multi-thread port scanner,python3.6.0") 
